...
$sql = "select MovieName,Description,MetaDescription,MetaKeywords,Price from test_Movie where MovieID = " . $myID;
//---end config area --------------------------------------------------
...
{#only load data if record found
	$title = $MovieName . " Marvelous Movies!"; #overwrite title with Muffin info!
}
# END CONFIG AREA ---------------------------------------------------------- 
...
<p>This is my Marvelous Movie collection</p> 
<?php
if($foundRecord)
...
?>
	...
	<table align="center">
		<tr>
			...
			<td>We sell <?=$MovieName;?> Movies daily!</td>
		</tr>
		<tr>
			<td colspan="2">
...
<?php
    ...
    echo '<div align="center">What! No such Movie? There must be a mistake!!</div>';
    echo '<div align="center"><a href="movies.php">Another Movie?</a></div>';
}
